...
contract SwapMathTest is Test, GasSnapshot {
    function testComputeSwapTest_sufficientAmountInOneForZero() external {
        ...
        // (y / x) ^ 0.5 * 2^ (192 * 0.5)
        //  (y / x * 2^192) ^ 0.5
        uint160 priceX96 = uint160(FixedPointMathLib.sqrt(1 * FullMath.Q96 ** 2));
        uint160 targetPriceX96 = uint160(FixedPointMathLib.sqrt(101 * FullMath.Q96 ** 2 / 100));
    ...
    function testComputeSwapTest_insufficientAmountIntOneForZero() external {
        ...
        //  (y / x * 2^192) ^ 0.5
        uint160 priceX96 = uint160(FixedPointMathLib.sqrt(1 * FullMath.Q96 ** 2));
        uint160 targetPriceX96 = uint160(FixedPointMathLib.sqrt(1000 * FullMath.Q96 ** 2 / 100));
        uint128 liquidity = 2 ether;
        // expecting to get exactly 1 ether out
    ...
    function testComputeSwapTest_gasSwapZeroForOneExactInCapped() external {
        ...
        //  (y / x * 2^192) ^ 0.5
        uint160 priceX96 = uint160(FixedPointMathLib.sqrt(1 * FullMath.Q96 ** 2));
        uint160 targetPriceX96 = uint160(FixedPointMathLib.sqrt(99 * FullMath.Q96 ** 2 / 100));
        uint128 liquidity = 2 ether;
        int256 actualAmountIn = 1 ether;
        uint24 feePips = 600;
    ...
    function testComputeSwapTest_gasSwapOneForZeroExactInPartial() external {
        ...
        //  (y / x * 2^192) ^ 0.5
        uint160 priceX96 = uint160(FixedPointMathLib.sqrt(1 * FullMath.Q96 ** 2));
        uint160 targetPriceX96 = uint160(FixedPointMathLib.sqrt(1010 * FullMath.Q96 ** 2 / 100));
        uint128 liquidity = 2 ether;
    ...
    function testComputeSwapTest_gasSwapZeroForOneExactInPartial() external {
        ...
        //  (y / x * 2^192) ^ 0.5
        uint160 priceX96 = uint160(FixedPointMathLib.sqrt(1 * FullMath.Q96 ** 2));
        uint160 targetPriceX96 = uint160(FixedPointMathLib.sqrt(99 * FullMath.Q96 ** 2 / 1000));
        uint128 liquidity = 2 ether;
        int256 actualInputAmount = 1000;
        uint24 feePips = 600;
